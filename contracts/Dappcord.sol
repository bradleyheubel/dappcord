...
contract Dappcord is ERC721 {
    ...
    modifier onlyOwner() {
        ...
        _; // Represents function body of the function onlyOwner is applied to. Can also be moved above require if require should be checked after code in the function (unlikely)
    }
